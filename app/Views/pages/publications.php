                        ...
                        <!-- <div class="modal fade bs-example-modal-center" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true"> -->
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <form action="publications/savepub" name="addpub" id="addpub" method="post" enctype="multipart/form-data">
                                    <?= csrf_field() ?>
                                    <div class="modal-body">
                                        <div class="row mb-3">
                                            <div class="col-lg-4">
                                                    ...
                                                    <div class="">
                                                        <input class="form-control" type="number" value="0" id="pub_id">
                                                    </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <label for="parent_pub_id" class="col-form-label">PARENT PUB_ID</label>
                                                <div class="">
                                                    <input class="form-control" type="number" value="0" id="parent_pub_id">
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <label for="group_pub_id" class="col-form-label">GROUP PUB_ID</label>
                                                <div class="">
                                                    <input class="form-control" type="number" value="0" id="group_pub_id">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-7">
                                                <input class="form-control" type="url" id="api_url">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="api_user" class="col-sm-5 col-form-label">WP Rest API User</label>
                                            <div class="col-sm-7">
                                                <input class="form-control" type="text" id="api_user">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="api_pass" class="col-sm-5 col-form-label">WP Rest API Password</label>
                                            <div class="col-sm-7">
                                                <input class="form-control" type="password" value="" id="api_pass">
                                            </div>
                                        </div>
                                        <div class="alert alert-warning ">Here</div>    
                                    </div>
